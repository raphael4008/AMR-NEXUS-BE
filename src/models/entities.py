...
class Guidance(Base):
    ...
    # ── Role-Gated Content ──────────────────────────────────────────────────────
    user_role = Column(String, nullable=False)                      # "National Coordinator" | "County Veterinarian"
    guidance_markdown = Column(Text, nullable=True)                 # Full markdown brief from Claude

    # ── Generation Provenance ───────────────────────────────────────────────────
    generation_metadata = Column(JSON, nullable=True)              # {"model": "claude-sonnet-4-5", "tokens": 512, ...}
    status = Column(
        Enum(GuidanceStatusEnum),
        default=GuidanceStatusEnum.PENDING,
        nullable=False,
    )
