...
export default function Analytics() {
  ...
  const [sectorTrendData, setSectorTrendData] = useState([]);
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      const [summ, trend, path, sect, sectTrend, counties, pathogens] = await Promise.all([
        api.getSummary(qs),
        api.getMDRTrend(12, qs),
        api.getByPathogen(20, qs),
        api.getBySector(qs),
        api.getBySectorTrend ? api.getBySectorTrend(qs) : Promise.resolve([]),
    ...
    <div className="space-y-6">
      ...
      <div id="analytics-dashboard" ref={dashboardRef} className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <SectorPieChart data={sectorData} trendData={sectorTrendData} />
        </div>
