...
export default function NationalDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .catch((err) => {
        console.error('NationalDashboard fetch error:', err);
    ...
    try {
      const response = await fetch('http://localhost:8000/guidance', {
        ...
        body: JSON.stringify({
          ...
          user_role: user?.role || 'national',
          county: alert.county || 'National',
        }),
      });
