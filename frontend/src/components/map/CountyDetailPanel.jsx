...
// Tile sets for light and dark modes
const DARK_TILE = {
...
export default function CountyChoroplethMap({ onCountyClick, darkMode = true }) {
  ...
  const currentTile = darkMode ? DARK_TILE : LIGHT_TILE;
  const mapBackground = darkMode ? '#0A0E17' : '#F8FAFC';
          ...
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span style={{
                    textShadow: darkMode ? '0 1px 4px black' : '0 1px 4px white',
